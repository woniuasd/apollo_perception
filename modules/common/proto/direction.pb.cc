...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcommon_2fproto_2fdirection_2eproto = {
  false, false, 168, descriptor_table_protodef_modules_2fcommon_2fproto_2fdirection_2eproto, "modules/common/proto/direction.proto", 
  ...
  nullptr, file_level_enum_descriptors_modules_2fcommon_2fproto_2fdirection_2eproto, file_level_service_descriptors_modules_2fcommon_2fproto_2fdirection_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fcommon_2fproto_2fdirection_2eproto_getter() {
  return &descriptor_table_modules_2fcommon_2fproto_2fdirection_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fcommon_2fproto_2fdirection_2eproto(&descriptor_table_modules_2fcommon_2fproto_2fdirection_2eproto);
namespace apollo {
namespace common {
