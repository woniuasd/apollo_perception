...
class CameraValidDist PROTOBUF_FINAL :
...
class DstExistenceFusionConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  inline DstExistenceFusionConfig* New() const final {
    return CreateMaybeMessage<DstExistenceFusionConfig>(nullptr);
  }
...
inline void CameraValidDist::set_camera_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 camera_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
