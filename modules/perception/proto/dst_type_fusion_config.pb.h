...
class CameraDstTypeFusionParam PROTOBUF_FINAL :
...
class LidarDstTypeFusionParam PROTOBUF_FINAL :
...
class DstTypeFusionConfig PROTOBUF_FINAL :
...
inline void CameraDstTypeFusionParam::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void LidarDstTypeFusionParam::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
