...
class ProbabilisticFusionConfig PROTOBUF_FINAL :
...
inline void ProbabilisticFusionConfig::set_tracker_method(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 tracker_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void ProbabilisticFusionConfig::_internal_set_tracker_method(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  tracker_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
inline std::string* ProbabilisticFusionConfig::_internal_mutable_tracker_method() {
  _has_bits_[0] |= 0x00000001u;
  return tracker_method_.Mutable(::apollo::perception::fusion::ProbabilisticFusionConfig::_i_give_permission_to_break_this_code_default_tracker_method_, GetArena());
}
inline std::string* ProbabilisticFusionConfig::release_tracker_method() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return tracker_method_.ReleaseNonDefault(nullptr, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void ProbabilisticFusionConfig::set_data_association_method(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 data_association_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void ProbabilisticFusionConfig::_internal_set_data_association_method(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  data_association_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
inline std::string* ProbabilisticFusionConfig::_internal_mutable_data_association_method() {
  _has_bits_[0] |= 0x00000002u;
  return data_association_method_.Mutable(::apollo::perception::fusion::ProbabilisticFusionConfig::_i_give_permission_to_break_this_code_default_data_association_method_, GetArena());
}
inline std::string* ProbabilisticFusionConfig::release_data_association_method() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return data_association_method_.ReleaseNonDefault(nullptr, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void ProbabilisticFusionConfig::set_gate_keeper_method(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 gate_keeper_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void ProbabilisticFusionConfig::_internal_set_gate_keeper_method(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  gate_keeper_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
inline std::string* ProbabilisticFusionConfig::_internal_mutable_gate_keeper_method() {
  _has_bits_[0] |= 0x00000004u;
  return gate_keeper_method_.Mutable(::apollo::perception::fusion::ProbabilisticFusionConfig::_i_give_permission_to_break_this_code_default_gate_keeper_method_, GetArena());
}
inline std::string* ProbabilisticFusionConfig::release_gate_keeper_method() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return gate_keeper_method_.ReleaseNonDefault(nullptr, GetArena());
}
