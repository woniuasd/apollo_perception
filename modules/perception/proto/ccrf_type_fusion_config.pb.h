...
class CcrfTypeFusionConfig PROTOBUF_FINAL :
...
inline void CcrfTypeFusionConfig::set_classifiers_property_file_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 classifiers_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void CcrfTypeFusionConfig::_internal_set_classifiers_property_file_path(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  classifiers_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* CcrfTypeFusionConfig::_internal_mutable_classifiers_property_file_path() {
  _has_bits_[0] |= 0x00000001u;
  return classifiers_property_file_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* CcrfTypeFusionConfig::release_classifiers_property_file_path() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return classifiers_property_file_path_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void CcrfTypeFusionConfig::set_transition_property_file_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 transition_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void CcrfTypeFusionConfig::_internal_set_transition_property_file_path(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  transition_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* CcrfTypeFusionConfig::_internal_mutable_transition_property_file_path() {
  _has_bits_[0] |= 0x00000002u;
  return transition_property_file_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* CcrfTypeFusionConfig::release_transition_property_file_path() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return transition_property_file_path_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
