...
void PbfTrackerConfig::InternalSwap(PbfTrackerConfig* other) {
  ...
  type_fusion_method_.Swap(&other->type_fusion_method_, nullptr, GetArena());
  motion_fusion_method_.Swap(&other->motion_fusion_method_, nullptr, GetArena());
  shape_fusion_method_.Swap(&other->shape_fusion_method_, nullptr, GetArena());
  existence_fusion_method_.Swap(&other->existence_fusion_method_, nullptr, GetArena());
}
