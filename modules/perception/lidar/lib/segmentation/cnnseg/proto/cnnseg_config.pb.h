...
class CNNSegConfig PROTOBUF_FINAL :
...
inline void CNNSegConfig::set_param_file(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
inline std::string* CNNSegConfig::_internal_mutable_param_file() {
  _has_bits_[0] |= 0x00000001u;
  return param_file_.Mutable(::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_param_file_, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void CNNSegConfig::set_proto_file(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 proto_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline std::string* CNNSegConfig::_internal_mutable_proto_file() {
  _has_bits_[0] |= 0x00000002u;
  return proto_file_.Mutable(::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_proto_file_, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void CNNSegConfig::set_weight_file(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 weight_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline std::string* CNNSegConfig::_internal_mutable_weight_file() {
  _has_bits_[0] |= 0x00000004u;
  return weight_file_.Mutable(::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_weight_file_, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void CNNSegConfig::set_engine_file(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000008u;
 engine_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline std::string* CNNSegConfig::_internal_mutable_engine_file() {
  _has_bits_[0] |= 0x00000008u;
  return engine_file_.Mutable(::apollo::perception::lidar::CNNSegConfig::_i_give_permission_to_break_this_code_default_engine_file_, GetArena());
}
