...
class NCutSegmentationParam PROTOBUF_FINAL :
 ...
 public:
  ...
  ::apollo::perception::lidar::NCutParam* release_ncut_param();
...
class NCutParam PROTOBUF_FINAL :
...
inline void NCutSegmentationParam::set_ground_detector(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
inline std::string* NCutSegmentationParam::_internal_mutable_ground_detector() {
  _has_bits_[0] |= 0x00000001u;
  return ground_detector_.Mutable(::apollo::perception::lidar::NCutSegmentationParam::_i_give_permission_to_break_this_code_default_ground_detector_, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void NCutSegmentationParam::set_roi_filter(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
...
inline std::string* NCutSegmentationParam::_internal_mutable_roi_filter() {
  _has_bits_[0] |= 0x00000002u;
  return roi_filter_.Mutable(::apollo::perception::lidar::NCutSegmentationParam::_i_give_permission_to_break_this_code_default_roi_filter_, GetArena());
}
...
inline ::apollo::perception::lidar::NCutParam* NCutSegmentationParam::_internal_mutable_ncut_param() {
  ...
  if (ncut_param_ == nullptr) {
    auto* p = CreateMaybeMessage<::apollo::perception::lidar::NCutParam>(GetArena());
    ncut_param_ = p;
  }
  return ncut_param_;
}
inline ::apollo::perception::lidar::NCutParam* NCutSegmentationParam::mutable_ncut_param() {
  ...
  return _internal_mutable_ncut_param();
}
inline void NCutSegmentationParam::set_allocated_ncut_param(::apollo::perception::lidar::NCutParam* ncut_param) {
  ...
  if (ncut_param) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(ncut_param);
