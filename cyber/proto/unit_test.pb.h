...
inline void UnitTest::set_class_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void UnitTest::set_case_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 case_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Chatter::set_content(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void ChatterBenchmark::set_content(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
